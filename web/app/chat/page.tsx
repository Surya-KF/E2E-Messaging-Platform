                        ...
                        <div className={`flex flex-col ${isOwn ? 'items-end' : 'items-start'} max-w-xs sm:max-w-md`}>
                          ...
                          <div className={`relative px-4 py-3 rounded-2xl shadow-md ${
                            isOwn
                              ...
                              : "bg-gray-300 dark:bg-gray-700 text-gray-900 dark:text-gray-100 border border-gray-400 dark:border-gray-600"
                          ...
                          {/* Message timestamp - always shown below message */}
                          <div className={`text-xs text-gray-400 dark:text-gray-500 mt-1 px-2 ${isOwn ? 'text-right' : 'text-left'}`}>
                            {formatMessageTime(new Date(message.createdAt))}
                          </div>
                        </div>
                      </div>
