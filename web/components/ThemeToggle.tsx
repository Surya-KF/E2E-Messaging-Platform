...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="inline-flex items-center gap-2 px-3 py-2 text-sm font-medium rounded-xl bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-200 hover:bg-gray-200 dark:hover:bg-gray-700 transition-all duration-200 focus-ring"
      onClick={() => setTheme(next)}
    >
      {theme === 'dark' ? (
        // Sun icon (currently dark, show sun to indicate going light)
        <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
          <path d="M6.76 4.84 5.34 3.42 3.92 4.84l1.42 1.42 1.42-1.42Zm10.5 0 1.41-1.42 1.42 1.42-1.42 1.42-1.41-1.42ZM12 2h0v2h0V2Zm0 18h0v2h0v-2ZM4 12H2v0h2v0Zm18 0h-2v0h2v0Zm-3.66 7.76 1.42 1.42 1.42-1.42-1.42-1.42-1.42 1.42ZM4.84 17.24l-1.42 1.42 1.42 1.42 1.42-1.42-1.42-1.42ZM12 6a6 6 0 1 1 0 12A6 6 0 0 1 12 6Z"/>
        </svg>
      ) : (
      ...
      <span className="hidden sm:inline capitalize">{next}</span>
    </button>
  );
}
